...
SELECT 
  ...
  SAFE_CAST(REPLACE (valor_equipe_titular_man,".0","") AS FLOAT64) valor_equipe_titular_mandante,
  SAFE_CAST(REPLACE (valor_equipe_titular_vis,".0","") AS FLOAT64) valor_equipe_titular_visitante,
  SAFE_CAST(REPLACE (valor_medio_equipe_titular_man,".0","") AS FLOAT64) valor_medio_equipe_titular_mandante,
  SAFE_CAST(REPLACE (valor_medio_equipe_titular_vis,".0","") AS FLOAT64) valor_medio_equipe_titular_visitante,
