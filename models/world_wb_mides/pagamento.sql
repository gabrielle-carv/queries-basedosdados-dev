 ...
 pagamento_rj AS (
  ...
  pagamento_df AS (
    SELECT
     ...
     SAFE_CAST (CONCAT(RIGHT(numero_ordem_bancaria, LENGTH(numero_ordem_bancaria) - 6), ' ', codigo_ug, ' ', codigo_gestao, ' ', '5300108', ' ', (RIGHT(exercicio,2))) AS STRING) AS id_liquidacao_bd,
     SAFE_CAST (NULL AS STRING) AS id_liquidacao,
